 ...
 <?php require("components/navbar.php") ?><br><br>
    <div class="container">
        ...
        <div class="form-container">
            <div style="text-align: center;"><h2>Payment Confirmation</h2></div>
            <form action="payment_end-process_page.php">
                ...
                <div style="text-align: center;"><button class="proceed-button" type="submit" style="text-align: center;">Submit</button></div></div>
            </form>
        </div>
    </div>
</body>
