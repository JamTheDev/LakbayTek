...
<main>
    <div class="__background-card">
        ...
        <div class="__card-header">
            ...
            <div class="right">
                <span class="__title-text">ADMIN REGISTER</span>
            </div>
        </div>
        ...
        <form action="adminregister.php" method="post">
            ...
            <?php if (isset($_GET["err"])) : ?>
                <span class="__error-msg">
                    ...
                    <?php 
                        if ($_GET["err"] == 0) {
                            echo "Account already exists! Try <a style='color: red;' href='adminlogin.php'>logging in</a> to your account instead.";
                        }
            ...
            <span style="padding: 10px; font-size: 12px;">ALREADY HAVE AN ACCOUNT? <a href="adminlogin.php">LOGIN!</a></span>
        </form>
    </div>
</main>