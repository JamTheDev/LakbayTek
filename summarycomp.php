    ...
    <div id="accountModal" class="modal">
        <div class="modal-content">
            ...
            <div class="account-details">
				...
				<span>Email Verification: <span id="accountEmailVerification"></span><br>
                <span>Birthdate: <span id="accountBirthdate"></span></span><br>
                <span>User ID: <span id="accountUserID"></span></span><br><br>
                <button id="adminButton">Make Admin</button><br>
            </div>
        </div>
    </div>
...
function showAccountModal(accountName) {
    ...
    const accountEmailVerification = document.getElementById('accountEmailVerification');
    ...
    if (account) {
        ...
        accountEmailVerification.textContent = account.verified == 1 ? 'Yes' : 'No';
        ...
        accountEmailVerification.textContent = "N/A";
    ...
    accountModal.style.display = 'block';
        ...
        function makeAccountAdmin(accountUsername) {
            // Here, you can add the code to make the account an admin
            // For example, you can make an AJAX request to a PHP script that updates the account role in the database
            // After the account is successfully updated, you can show a success message or perform any other action
            console.log(`Making ${accountUsername} an admin...`);
        }
